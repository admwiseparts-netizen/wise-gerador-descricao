...
def copy_block(label: str, text: str, key: str, height: int = 180):
    ...
    <div style="border:1px solid #e6e6e6;border-radius:10px;padding:12px;background:#fafafa;">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
        ...
        <button
          id="btn-{key}"
          style="padding:6px 10px;border-radius:8px;border:1px solid #d0d0d0;background:white;cursor:pointer;font-size:13px;"
      ...
      <textarea id="ta-{key}" readonly
        style="width:100%;height:{height}px;resize:vertical;border-radius:8px;border:1px solid #e6e6e6;padding:10px;font-size:13px;line-height:1.35;background:white;"
      >{safe_text}</textarea>
    </div>
    """
...
with right:
    st.markdown("""
    <div style="text-align:right;border:1px solid #e6e6e6;padding:10px 12px;border-radius:10px;background:#fafafa;font-size:14px;">
      <b>NCM:</b> 87141000<br>
      <b>CEST:</b> 0107600
    </div>
    """, unsafe_allow_html=True)
